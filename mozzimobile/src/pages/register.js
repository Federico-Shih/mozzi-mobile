...
class Register extends Component<Props> {
  ...
  checkIfPasswordsMatchAndSet = (
    { password, tempConfirmedPassword } = this.state,
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        />
        <View style={{ height: 20 }}>{this.displayErrorMessage('name')}</View>
        ...
        <Input
          ...
          onChangeText={(text) => {
            this.setState({ tempConfirmedPassword: text });
          }}
          onSubmitEditing={() => {
